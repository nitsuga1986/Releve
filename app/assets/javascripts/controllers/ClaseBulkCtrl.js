angular.module("TurnosApp").controller("ClaseBulkCtrl",['$scope', '$q', '$http', '$routeParams', '$location', 'ResourceClase', function($scope, $q, $http, $routeParams, $location, ResourceClase) {
	$scope.FormErrors = [];
